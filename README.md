...
```html
1. Get OpenAI API key = <a href="https://platform.openai.com/account/api-keys">https://platform.openai.com/account/api-keys</a>
...
### Settings
```bash
maxToken - keep in mind that by increasing this parameter, you also increase the cost of the request
```
```bash
